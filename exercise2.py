...
#Expected Output: Error (Because this program can only name shapes that have upto 10 sides)
elif name_that_shape > 10:
    print('Error: This program can only name shapes that have upto 10 sides')
